...
namespace App\Models {
     ...
     * @property-read \App\Models\Klasifikasi $klasifikasi
     * @method static \Illuminate\Database\Eloquent\Builder<FotoMata>|FotoMata whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FotoMata>|FotoMata whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FotoMata>|FotoMata whereFilePath($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FotoMata>|FotoMata whereUploadDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FotoMata>|FotoMata whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FotoMata>|FotoMata whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FotoMata>|FotoMata newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<FotoMata>|FotoMata newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<FotoMata>|FotoMata query()
     ...
     */
    class FotoMata extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\Klasifikasi
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property float|null $akurasi
     * @property string|null $hasil
     * @property int $foto_id
     * @property int $id
     * @property-read \App\Models\FotoMata $fotoMata
     * @method static \Illuminate\Database\Eloquent\Builder<Klasifikasi>|Klasifikasi whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Klasifikasi>|Klasifikasi whereFotoId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Klasifikasi>|Klasifikasi whereHasil($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Klasifikasi>|Klasifikasi whereAkurasi($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Klasifikasi>|Klasifikasi whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Klasifikasi>|Klasifikasi whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Klasifikasi>|Klasifikasi newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Klasifikasi>|Klasifikasi newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Klasifikasi>|Klasifikasi query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Klasifikasi extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\FotoMata> $fotoMata
     * @property-read int|null $fotoMata_count
